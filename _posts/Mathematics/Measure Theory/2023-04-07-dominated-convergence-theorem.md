...
$$\begin{aligned}        \mu\left( \{\lvert u \rvert = \infty\} \cap E \right) & = \mu\left( \bigcap_{n=1}^\infty \{x \in E : \lvert u(x) \rvert \geq n\} \right) \\                                               & = \lim_{n \rightarrow\infty} \mu\left( \{\lvert u \rvert \geq n\} \cap E \right) \leq \limsup_{n\rightarrow\infty} \frac{1}{n} \int_E \lvert u \rvert \,d{\mu} = 0    \end{aligned}$$
