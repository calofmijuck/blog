...
![k8s-11 1.jpeg](../../../assets/img/posts/k8s-11%201.jpeg) _The chain of events that unfolds when a Deployment resource is posted to the API server (출처: https://livebook.manning.com/book/kubernetes-in-action/chapter-11)_
